     ...
     <div className="d-flex flex-column navbar">
        ...
        <ul className="nav nav-pills flex-column mb-auto">
          <li className="nav-item">
            <a href="/" className="nav-link d-flex" aria-current="page"><i className="fas fa-home text-center"></i>
              <h2 className="my-auto">Home</h2>
            </a>
          </li>
          <li className="nav-item">
            <a href="/" className="nav-link d-flex"><i className="fas fa-search text-center"></i> 
              <h2 className="my-auto">Search</h2>
            </a>
          </li>
          <li className="nav-item">
            <a href="/" className="nav-link d-flex"><i className="fas fa-book text-center"></i>
        ...
        <div className='mx-auto d-flex flex-column nav-text-block'>
          ...
          <p className="nav-text-bottom"> Policy </p>  
            ...
            {/* <Nav classNameName="col-md-12 d-none d-md-block bg-dark sidebar"
            activeKey="/home"
            onSelect={selectedKey => alert(`selected ${selectedKey}`)}
            >
                <div classNameName="sidebar-sticky"></div>
            <Nav.Item>
